...
var CProc = __importStar(require("child_process"));
// DEFAULTS
...
var FIGMA_FILE_KEY = "59071-236aa42a-1cd8-4651-bca6-1bad14cad93f";
            ...
            switch (_a.label) {
                case 0:
                    fetch = function () {
                        ...
                        return import("node-fetch").then(function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var cmd = "curl --silent -X GET       --header \"X-Figma-Token: ".concat(FIGMA_FILE_KEY, "\"       ").concat(url);
...
function iterateRESTAPIExample() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, getFigmaFileViaRESTAPI({
